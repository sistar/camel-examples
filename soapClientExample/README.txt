ACHTUNG PORTS F�R TunneliJ oder Eclipse TCP Monitor gesetzt:
Server:  http://localhost:8181/cxf/sample/webservices/incident?wsdl
Client nutzt: 8182
...
To run the example on Apache ServiceMix 4.x or Apache Karaf 2.2.x
 ...
 com.sun.org.apache.xerces.internal.jaxp, \
  ...
  Note: In this example we use Apache Camel 2.8.2 as the version. You should of course use the
